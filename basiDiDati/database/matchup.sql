...
INSERT INTO `Gara` (`ID`, `casa`, `trasferta`, `giornata`, `torneo`, `risultato`, `vincitore`) VALUES
(740, 'francesco', 'giocatore', 1, 17, '1-0', 'francesco'),
(741, 'valeria', 'riccardo', 1, 17, '2-1', 'valeria'),
(742, 'francesco', 'valeria', 2, 17, '2-0', 'francesco'),
(743, 'francesco', 'giocatore', 1, 16, NULL, NULL),
(744, 'giocatore', 'francesco', 2, 16, NULL, NULL),
(745, 'valeria', 'giocatore', 3, 16, NULL, NULL),
(746, 'giocatore', 'valeria', 4, 16, NULL, NULL),
(747, 'francesco', 'valeria', 5, 16, NULL, NULL),
(748, 'valeria', 'francesco', 6, 16, NULL, NULL);
...
INSERT INTO `Gara_torneo_libero` (`ID`, `torneo`, `giornata`, `utente`, `risultato`, `punti`) VALUES
(10, 18, 1, 'francesco', '1', 2),
(11, 18, 1, 'riccardo', '4', 3),
(12, 18, 1, 'valeria', '6', 5),
(13, 18, 2, 'giocatore', NULL, NULL),
(14, 18, 2, 'riccardo', '10', 5),
(15, 18, 2, 'valeria', '4', 8),
(16, 18, 3, 'francesco', NULL, NULL),
(17, 18, 3, 'giocatore', NULL, NULL),
(18, 18, 3, 'riccardo', NULL, NULL),
(19, 18, 3, 'valeria', NULL, NULL);
...
INSERT INTO `Iscrizione` (`utente`, `torneo_id`, `punteggio`, `posizione`, `prezzo`, `premio`, `approvato`) VALUES
('francesco', 16, 0, 2, '0.00', '0.00', 1),
('francesco', 17, 22, 3, '0.00', '0.00', 1),
('francesco', 18, 0, 0, '0.00', '0.00', 1),
('giocatore', 16, 3, 1, '0.00', '0.00', 1),
('giocatore', 17, 28, 2, '0.00', '0.00', 1),
('giocatore', 18, 0, 0, '0.00', '0.00', 1),
('riccardo', 16, 0, 0, '25.00', '50.00', 0),
('riccardo', 17, 18, 4, '0.00', '0.00', 1),
('riccardo', 18, 0, 0, '0.00', '0.00', 1),
('valeria', 16, 0, 3, '0.00', '0.00', 1),
('valeria', 17, 36, 1, '0.00', '0.00', 1),
('valeria', 18, 0, 0, '0.00', '0.00', 1);
...
INSERT INTO `Torneo` (`ID`, `nome`, `edizione`, `data`, `ora`, `min_giocatori`, `max_giocatori`, `numero_gare`, `tipo`, `organizzatore`) VALUES
(16, 'scacchi', 1, '2016-02-11', '00:12:00', 2, 7, NULL, 'italiana', 'riccardo'),
(17, 'diretta', 1, '2016-02-24', '11:11:00', 2, 32, NULL, 'eliminazione diretta', 'riccardo'),
(18, 'libero', 1, '2016-02-18', '11:11:00', 2, 32, NULL, 'libero', 'riccardo');
...
(23, NULL, NULL, 'mia@email.it', 'riccardo', '5f4dcc3b5aa765d61d8327deb882cf99', 'organizzatore', 1, 125),
(24, NULL, NULL, 'mia@email.ti', 'valeria', '5f4dcc3b5aa765d61d8327deb882cf99', 'giocatore', 1, 100),
(25, NULL, NULL, 'mia@email.it', 'francesco', '5f4dcc3b5aa765d61d8327deb882cf99', 'giocatore', 1, 100),
(26, NULL, NULL, 'mia@email.it', 'giocatore', '5f4dcc3b5aa765d61d8327deb882cf99', 'giocatore', 1, 100);
